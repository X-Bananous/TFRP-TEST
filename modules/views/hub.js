            ...
            <aside class="hidden md:flex relative top-0 bottom-0 left-0 z-[100] w-72 h-[100dvh] bg-[#08080a]/95 backdrop-blur-3xl border-r border-white/5 flex-col shadow-2xl">
                ...
                <div class="p-6 border-t border-white/5 shrink-0 bg-[#0c0c0e]">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <button onclick="actions.confirmLogout()" class="w-full glass-btn-secondary py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-widest text-red-500 hover:bg-red-500/10 border-red-500/20 flex items-center justify-center gap-3">
